          ...
          <div className="flex items-center space-x-3 sm:space-x-5 min-w-0 flex-1">
            ...
            {challenge?.type === "code" && (
              <select
                ...
                className="bg-slate-700/50 text-slate-300 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-md sm:rounded-lg text-xs sm:text-sm border border-slate-600/50 focus:border-blue-500 focus:outline-none backdrop-blur-sm"
              >
                    ...
                    >
                      ...
                      {isRunning ? (
                        <>
                          ...
                          <span className="relative z-10 hidden sm:inline ml-3">Running...</span>
                        </>
                      ) : (
                ...
                >
                  ...
                  {isSubmitting ? (
                    <>
                      ...
                      <span className="relative z-10 hidden sm:inline ml-3">Submitting...</span>
                    </>
                  ) : (
              ...
              <div className="p-4 sm:p-5 h-full flex items-center justify-center">
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-slate-700/50 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <BookOpen size={24} className="sm:w-7 sm:h-7 text-slate-400" />
                  </div>
