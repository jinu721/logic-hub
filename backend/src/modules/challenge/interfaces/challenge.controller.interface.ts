...
export interface IChallengeController {
  ...
  getChallengesByStatus(req: Request, res: Response, next: NextFunction): Promise<void>;
  getChallengesByTags(req: Request, res: Response, next: NextFunction): Promise<void>;
  getChallengesByDifficulty(req: Request, res: Response, next: NextFunction): Promise<void>;
