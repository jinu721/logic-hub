...
export const generateCompiledWrapper = (
  ...
  switch (language.toLowerCase()) {
    case "c": return cWrapper(userCode, funcName, testCases);
    case "cpp":
    case "c++": return cppWrapper(userCode, funcName, testCases);
    case "java": return javaWrapper(userCode, funcName, testCases);
    case "c#":
    case "csharp":
    case "cs": return csharpWrapper(userCode, funcName, testCases);
    case "go": return goWrapper(userCode, funcName, testCases);
    case "rust": return rustWrapper(userCode, funcName, testCases);
